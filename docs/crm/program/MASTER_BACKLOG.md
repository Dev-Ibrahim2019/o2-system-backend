...
| E-08 | E | Conflict Resolution Policy | P0 | All | [R] | E-01 | Proposed: authority-aware conditional conflict resolution with exact versions/revisions, cross-system acceptance fencing, one valid commit, explicit conflicts, authority-based projection repair and governed review; ready for architecture review. |
