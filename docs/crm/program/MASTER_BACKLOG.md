...
| E-10 | E | External Order Identifier and Reference Contract | P0 | All | [R] | E-01 | Proposed: typed stable external-reference contract; immutable Website Public Order Ref survives Cloud→Laravel handoff; internal PK, display number, revision, command, correlation, handoff, idempotency, proof, Payment, and identity refs remain semantically distinct. |
