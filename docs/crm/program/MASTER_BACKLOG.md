...
| E-09 | E | Unified Customer Identity | P0 | All | [R] | E-01 | Proposed: federated Cloud Portal Account and Laravel canonical Customer with Laravel/CRM-authoritative governed Link, safe exact-phone matching, Limited Account/review for ambiguity, governed history-preserving merge/unlink, and explicit company membership. |
