...
| EA-02 | E | Canonical Status Dictionary | P0 | All | [R] | E-05,E-08 | Proposed: domain-specific canonical status dictionaries, lowercase snake_case machine values, explicit legacy mapping, and strict separation of business, transport, outcome, event, timestamp, and display concepts. |
