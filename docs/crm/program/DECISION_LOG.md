...
| E-04 | [Notification Storage](../architecture/ADR-E-04-NOTIFICATION-STORAGE.md) | [R] Proposed — Ready for Architecture Review | Cloud-authoritative logical customer Notification and in-app inbox; domain facts remain with Laravel or Cloud Conversation authority; per-item read/dismiss state; one logical Notification with channel attempts; minimal Laravel projection; internal staff alerts remain Laravel/operations-authoritative. |
...
E-01 and E-02 are **[x] Approved** on 2026-08-06. E-03 is **[x] Approved** on 2026-08-07. E-04 is **[R] Proposed — Ready for Architecture Review**. E-05 through E-10 remain **Pending**.
