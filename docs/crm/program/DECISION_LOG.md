...
| E-03 | [Conversation and Message Storage](../architecture/ADR-E-03-CONVERSATION-MESSAGE-STORAGE.md) | [R] Proposed — Ready for Architecture Review | Cloud-authoritative Conversation and Public Message storage with an authorized, stale-aware Laravel operational projection; Internal Notes remain Laravel-only; staff actions are Laravel-authorized and Cloud-confirmed. |
...
E-01 and E-02 are **[x] Approved** on 2026-08-06. E-03 is **[R] Proposed — Ready for Architecture Review**. E-04 through E-10 remain **Pending**.
